            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              {cat.entries.map((e, i) => (
                <div key={i} style={{
                  ...
                  fontFamily: cat.warn ? 'var(--font-serif)' : 'Inter, sans-serif',
...
function PoeticSidebarV2({ profile, totalMessages }) {
  ...
  return (
    <div className="mirror-conv-scroll" style={{
      fontFamily: 'Inter, sans-serif', color: '#141C21',
      padding: '36px 32px 80px', height: '100%', overflowY: 'auto',
      background: 'linear-gradient(180deg, oklch(0.97 0.008 80), oklch(0.95 0.012 230))',
    }}>
      <div style={{
        fontFamily: "'JetBrains Mono', monospace",
        fontSize: 9, letterSpacing: '0.3em', textTransform: 'uppercase',
